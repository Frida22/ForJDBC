...
public class MainJDBC {
        ...
        try {
            try {
                ...
                while (true) {
                    ...
                    System.out.println("6: choose clients");
                    System.out.print("-> ");
    ...
    private static void addClient(Scanner sc) throws SQLException {
        ...
        String salaryC = sc.nextLine();
        int salary = Integer.parseInt(salaryC);
    ...
    private static void toChooseClients(Scanner sc) throws SQLException {
        ...
        try {
            ...
            resultSet.close(); // rs can't be null according to the docs
        }
    }
}
